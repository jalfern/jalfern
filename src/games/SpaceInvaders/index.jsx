...
const SpaceInvadersGame = () => {
    ...
    useEffect(() => {
        ...
        // Initialize logic
        const initGame = () => {
            console.log("SpaceInvaders: initGame with size", state.width, state.height)
        ...
        const resize = () => {
            if (containerRef.current && canvas) {
                ...
                if (width === 0 || height === 0) {
                    console.warn("SpaceInvaders: 0 dimensions detected on resize, retrying...")
                ...
                state.height = height
                initGame()
                console.log("SpaceInvaders Resize Success:", width, height)
            }
        }
        ...
        const draw = () => {
            ...
            // Debug Draw
            if (state.width === 0) console.warn("SpaceInvaders: 0 width during draw")
